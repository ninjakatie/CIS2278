...
@rem     call dbSetenv_ndnu.cmd script to set up the Derby environment
call dbSetenv_ndnu
...
java -Dij.driver=org.apache.derby.jdbc.ClientDriver -Dij.database=%DB_NAME%;create=true -Dij.user=guest -Dij.password=password org.apache.derby.tools.ij dbCreate_ndnu.sql
